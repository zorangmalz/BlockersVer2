...
export default function SolutionCTwo({ navigation,route }) {
    ...
    const pushone = () => {
        ...
        setTimeout(() => {
            navigation.navigate('SolutionCThree',{sc:Number(JSON.stringify(sc))+1,UID:UID});
        }, 200)
    }
    ...
    const pushtwo = () => {
        ...
        setTimeout(() => {
            navigation.navigate('SolutionCThree',{sc:Number(JSON.stringify(sc))+2,UID:UID});
        }, 200)
    }
    ...
    const pushthree = () => {
        ...
        setTimeout(() => {
            navigation.navigate('SolutionCThree',{sc:Number(JSON.stringify(sc))+3,UID:UID});
        }, 200)
    }
    ...
    const pushfour = () => {
        ...
        setTimeout(() => {
            navigation.navigate('SolutionCThree',{sc:Number(JSON.stringify(sc))+4,UID:UID});
        }, 200)
    }
    ...
    const pushfive = () => {
        ...
        setTimeout(() => {
            navigation.navigate('SolutionCThree',{sc:Number(JSON.stringify(sc))+5,UID:UID});
        }, 200)
    }
    ...
    return (
        <>
            ...
            <SafeAreaView style={{ flex: 1, backgroundColor: '#FFFFFF' }}>
                ...
                <ScrollView>
                    <Text style={solution.largeText}>담배연기를 내뿜으면 나른한 행복감을 느낄 수 있나요?</Text>
                    {one === false ?
