...
export default function SolutionGOne({ navigation ,route}) {
    ...
    const pushone = () => {
        ...
        setTimeout(() => {
            navigation.navigate('SolutionGTwo',{sg:1,UID:UID});
        }, 200)
    }
    ...
    const pushtwo = () => {
        ...
        setTimeout(() => {
            navigation.navigate('SolutionGTwo',{sg:2,UID:UID});
        }, 200)
    }
    ...
    const pushthree = () => {
        ...
        setTimeout(() => {
            navigation.navigate('SolutionGTwo',{sg:3,UID:UID});
        }, 200)
    }
    ...
    const pushfour = () => {
        ...
        setTimeout(() => {
            navigation.navigate('SolutionGTwo',{sg:4,UID:UID});
        }, 200)
    }
    ...
    const pushfive = () => {
        ...
        setTimeout(() => {
            navigation.navigate('SolutionGTwo',{sg:5,UID:UID});
        }, 200)
    }
    ...
    return (
        <>
            ...
            <SafeAreaView style={{ flex: 1, backgroundColor: '#FFFFFF' }}>
                ...
                <ScrollView>
                    <Text style={solution.largeText}>주위 사람들이 흡연하면 나도 담배를 피우나요?</Text>
                    {one === false ?
