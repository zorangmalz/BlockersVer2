        ...
        <>
            ...
            <SafeAreaView style={{ backgroundColor: '#FFFFFF', flex: 1 }}>
                ...
                <ScrollView style={{ marginBottom: 70, paddingTop: 35 }}>
                    ...
                    />
                    <Text style={{ fontSize: 12, fontFamily: 'NunitoSans-Regular', color: '#ff0000', marginLeft: "7.5%", marginTop: 4 }}>금액을 입력해주세요</Text>
                    <Text style={{
                        fontSize: 16,
                    ...
                    <View style={{ marginLeft: 32, marginTop: 16, flexDirection: 'row', alignItems: 'center' }}>
                        <Text style={{ fontSize: 16, fontFamily: 'NunitoSans-Regular', color: '#333333' }}>우리은행 1002-550-568544</Text>
                    ...
                    <View style={{ width: "90%", height: 170, backgroundColor: '#E6E6E6', alignSelf: 'center', paddingTop: 16, paddingBottom: 16, paddingRight: 32, paddingLeft: 32, marginBottom: 16, marginTop: 16 }} >
                        <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 8 }}>
                            ...
                            <Text style={{ fontSize: 14, fontFamily: 'NunitoSans-Bold', color: '#333333', marginLeft: 8 }}>입금시 주의사항</Text>
                        </View>
                        <View>
                            <Text style={{ fontSize: 14, fontFamily: 'NunitoSans-Regular', color: '#333333', marginBottom: 2 }}>- 입력한 금액만큼만 입금해주세요.</Text>
                            <Text style={{ fontSize: 14, fontFamily: 'NunitoSans-Regular', color: '#333333', marginBottom: 2 }}>  입금액과 일차하지 않을시 처리되지 않습니다.</Text>
                            <Text style={{ fontSize: 14, fontFamily: 'NunitoSans-Regular', color: '#333333', marginBottom: 2 }}>- 보이스 피싱 등 금융사고 예방을 위하 첫 입금 후</Text>
                            <Text style={{ fontSize: 14, fontFamily: 'NunitoSans-Regular', color: '#333333', marginBottom: 2 }}>  72시간동안 출금이 제한됩니다.</Text>
                        </View>
                    </View>
                    <View style={{ flexDirection: 'row', alignItems: 'center', alignSelf: 'center' }}>
                        ...
                        <Text style={{ fontSize: 14, fontFamily: 'NunitoSans-Regular', color: '#333333', marginLeft: 8 }}>입금시 주의사항을 확인했습니다.</Text>
                    </View>
                </ScrollView>
                {(check===true)&&(value.length>0) ?
                    <TouchableOpacity style={{ position: 'absolute', bottom: 0, right: 0, left: 0 }}>
                        <View style={{ width: "100%", height: 60, backgroundColor: '#5cc27b', justifyContent: 'center', alignItems: 'center' }}>
                            <Text style={{ fontSize: 18, color: '#ffffff', fontFamily: 'NunitoSans-Regular' }}>입금하기</Text>
                        </View>
                    </TouchableOpacity>
                    :
