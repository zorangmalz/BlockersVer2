...
const sg="•	타인이 담배를 권하거나 흡연하면 당신도 담배를 피우는 유형이다.\n• 금연한다는 것을 다른 사람들에게 알리는 것이 중요하다.\n• 가급적 흡연을 유혹/자극 하는 모임은 피하는 것이 좋다.\n"
...
async function load(){
    const list=[]
    await firestore()
  .collection('UserInfo').doc(user.uid).collection("Solution")
  // Order results
