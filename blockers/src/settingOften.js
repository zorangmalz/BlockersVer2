...
export default function SettingOften({ navigation }) {
    return (
        <SafeAreaProvider>
            <SafeAreaView accessibilityRole="header" style={{ flexDirection: 'row', alignItems: "center", height: 50, paddingTop: 5, width: "100%", paddingLeft: "3%", paddingRight: "3%", backgroundColor: '#ffffff' }}>
