...
export function AlcoholMain({ navigation,route }) {
    ...
    const title = "알콜중독은 흡연 실패에 큰 영향을 미칩니다. \n검사를 통해 본인의 알콜중독정도를 파악해보세요.";
