            ...
            <SafeAreaView style={{flex: 1, backgroundColor: '#ffffff'}}>
                <ScrollView>
                    ...
                    <View style={{
                        ...
                        <Text style={{ fontSize: 16, fontWeight: 'normal', opacity: 0.8 }}>인증번호를 받지 못하셨나요?</Text>
                        <TouchableOpacity style={{
                            width: "25%",
                            alignItems: 'center',
                            justifyContent: 'center'
                        }}>
                            <Text style={{ fontSize: 16, fontWeight: 'bold', opacity: 0.8, textDecorationLine: 'underline' }}>재전송</Text>
                        </TouchableOpacity>
                    </View>
                </ScrollView>
