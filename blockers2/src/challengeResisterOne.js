                    ...
                    <View style={{marginTop: 32}}>
                        <View style={{
                            ...
                            <View style={[challenge.circle,{backgroundColor: '#5CC27B'}]}>
                                <Text style={[challenge.numText,{color: '#ffffff', fontWeight: 'bold'}]}>1</Text>
                            </View>
                    ...
                    <View style={challenge.box}>
                        ...
                        <View style={{
                            ...
                            <View style={{flexDirection: 'row', justifyContent: 'space-between', marginBottom: 8}}>
                                <Text style={[challenge.mediumText, { fontWeight: 'bold' }]}>챌린지 금액</Text>
                                <Text style={challenge.mediumText}>10,000원~100,000원</Text>
                            </View>
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 8 }}>
                                <Text style={[challenge.mediumText, { fontWeight: 'bold' }]}>인증횟수</Text>
                                <Text style={challenge.mediumText}>2주 1회, 총 2회</Text>
                            </View>
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 8 }}>
                                <Text style={[challenge.mediumText, { fontWeight: 'bold' }]}>페널티</Text>
                                <Text style={challenge.mediumText}>30%</Text>
                            </View>
                            <View style={{ flexDirection: 'row', justifyContent: 'flex-start', marginBottom: 16 }}>
                                <Text style={[challenge.mediumText, { fontWeight: 'bold' }]}>인증방법</Text>
                            </View>
                            <View style={{flexDirection:'row', alignItems: 'center', justifyContent: 'space-between'}}>
                                <View style={{justifyContent: 'center', alignItems: 'center'}}>
                                    ...
                                    <Text style={[challenge.mediumText,{fontWeight: 'bold', color: '#5cc27b', marginTop: 4}]}>1</Text>
                                </View>
                                <View style={{justifyContent: 'center', alignItems: 'center'}}>
                                    <Image style={{width: 80, height: 80, borderColor: '#707070', borderWidth:1}} resizeMode="contain" source={require('./icon/kitone.png')} />
                                    <Text style={[challenge.mediumText,{fontWeight: 'bold', color: '#5cc27b', marginTop: 4}]}>2</Text>
                                </View>
                                <View style={{justifyContent: 'center', alignItems: 'center'}}>
                                    <Image style={{width: 80, height: 80, borderColor: '#707070', borderWidth:1}} resizeMode="contain" source={require('./icon/kittwo.png')} />
                                    <Text style={[challenge.mediumText,{fontWeight: 'bold', color: '#5cc27b', marginTop: 4}]}>3</Text>
                                </View>
                            </View>
                            <View style={{ marginTop: 16, alignItems: 'flex-start', justifyContent: 'center' }}>
                                ...
                                <Text style={challenge.mediumText}>3. 3-5분 후 검사결과가 나오면 타액검사 키트를 손에 쥔</Text>
                                <Text style={[challenge.mediumText, { marginBottom: 8 }]}>    상태로 결과 부분을 촬영합니다.</Text>
