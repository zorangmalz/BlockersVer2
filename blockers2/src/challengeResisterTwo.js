            ...
            <SafeAreaView style={{flex: 1, backgroundColor: '#ffffff'}}>
                <ScrollView style={{marginBottom: 70}}>
                    {info===false ? 
                        ...
                        <View style={{
                            ...
                            <Text style={{marginBottom: 16}}>
                                <Text style={[challenge.largeText,{fontWeight: 'normal'}]}>당신의</Text>
                                <Text style={[challenge.largeText,{color: '#FFB83D'}]}> 챌린지 성공</Text>
                                <Text style={[challenge.largeText,{fontWeight: 'normal'}]}>을 돕기위한</Text>
                            ...
                            <Text style={{marginBottom: 8}}>
                                <Text style={[challenge.largeText,{fontWeight: 'normal'}]}>1. 입이 심심한 당신을 위한 </Text>
                                <Text style={[challenge.largeText,{color: '#FFB83D'}]}>무가당 껌 5 set</Text>
                            </Text>
                            <Text style={{marginBottom: 8}}>
                                <Text style={[challenge.largeText,{fontWeight: 'normal'}]}>2. 금연하는 것을 자연스럽게! </Text>
                                <Text style={[challenge.largeText,{color: '#FFB83D'}]}>금연 굿즈!</Text>
                            </Text>
                            <Text style={{marginBottom: 18}}>
                                <Text style={[challenge.largeText,{fontWeight: 'normal'}]}>3. 금연 잘하고 있나? </Text>
                                <Text style={[challenge.largeText,{color: '#FFB83D'}]}>타액검사키트 2 set!</Text>
                            </Text>
                            <Text style={[challenge.kitText,{marginBottom: 16}]}>특별혜택</Text>
                            <Text style={{marginBottom: 16}}>
                                <Text style={[challenge.largeText,{fontWeight: 'normal'}]}>챌린지에 성공하면 </Text>
                    ...
                    <View style={{ marginTop: 32 }}>
                        <View style={{
                            ...
                            <View style={[challenge.circle, { backgroundColor: '#5CC27B' }]}>
                                <Text style={[challenge.mediumText, { color: '#ffffff', fontWeight: 'bold' }]}>2</Text>
                            </View>
                            <View style={challenge.bar} />
                            <View style={[challenge.circle, { backgroundColor: '#ffffff' }]}>
                    ...
                    <View style={{alignSelf: 'flex-start', marginTop: 32, marginLeft: 16}}>
                        <Text style={[challenge.mediumText,{fontWeight: 'bold'}]}>참가자 정보</Text>
                    </View>
                    <View style={{
                        marginTop: 18,
                        marginLeft: 18,
                        ...
                        <View style={{
                            ...
                            <Text style={[challenge.mediumText, {marginBottom: 7, fontWeight: 'bold'}]}>{username}</Text>
                            <Text style={[challenge.mediumText, {fontWeight: 'bold'}]}>{phoneNumber}</Text>
                        </View>
                    </View>
                    <View style={{
                        marginTop: 44,
                        ...
                        <Text style={[challenge.mediumText, {fontWeight: 'bold'}]}>참가금액</Text>
                        <TextInput value={money} keyboardType="numeric" onChangeText={text => setMoney(text)} placeholder="최소 10,000 ~ 최대 100,000" placeholderTextColor="#C6C6C6" style={{width:"53%", height: 40, borderRadius: 5, borderWidth: 1, borderColor: '#C6C6C6', marginLeft: 20}}/>
                        <Text style={[challenge.mediumText, {fontWeight: 'bold'}]}>BLOCK</Text>
                    </View>
                    <View style={{alignSelf: 'center', marginTop: 8, marginRight: 50}}>
                        <Text style={{fontSize: 12, color: '#FF0000'}}>입력가능 : 100,000</Text>
                    </View>
                    <View style={{
                        marginTop: 32,
                        marginLeft: 16,
                        ...
                        <Text style={[challenge.mediumText, {fontWeight: 'bold', marginRight: 4}]}>챌린지 키트</Text>
                            ...
                            <View style={{
                                ...
                                <TouchableOpacity style={{marginLeft: 16}} onPress={() => navigation.navigate('주소찾기')}>
                                    <View style={{
                                        ...
                                        <Text style={{fontSize: 12, fontWeight: 'bold', color: '#FFFFFF'}}>주소찾기</Text>
                                    </View>
                                </TouchableOpacity>
                            </View>
                            <View style={{
                    ...
                    <View style={{
                        ...
                        <Text style={[challenge.largeText, { fontWeight: 'normal', marginLeft: 8, textDecorationLine: 'underline' }]}>기타 약관</Text>
                    </View>
                    ...
                    {YesorNo === 2 ?
                        <View>
                            <View style={{
                                ...
                                <Text style={[challenge.largeText, { fontWeight: 'normal' }]}>참가금액</Text>
                                <Text style={[challenge.largeText, { fontWeight: 'normal' }]}>{money} Block</Text>
                            </View>
                            <View style={{
                                flexDirection: 'row',
                                justifyContent: 'space-between',
                                ...
                                <Text style={[challenge.largeText, { fontWeight: 'normal' }]}>챌린지 키트</Text>
                                <Text style={[challenge.largeText, { fontWeight: 'normal' }]}>12,500 Block</Text>
                            </View>
                            <View style={{
                                flexDirection: 'row',
                                justifyContent: 'space-between',
                                ...
                                <Text style={{ fontSize: 21, fontWeight: 'bold' }}>총금액</Text>
                                <Text style={{ fontSize: 21, fontWeight: 'bold' }}>{totalmoney} Block</Text>
                            </View>
                        </View>
                        :
                        <View>
                            ...
                            <View style={{
                                ...
                                <Text style={{ fontSize: 21, fontWeight: 'bold' }}>총금액</Text>
                                <Text style={{ fontSize: 21, fontWeight: 'bold' }}>{money} Block</Text>
                            </View>
                        </View>
                    }
                </ScrollView>
