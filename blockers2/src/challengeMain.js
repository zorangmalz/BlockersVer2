                        ...
                        <View style={{
                            ...
                            <View style={{
                                ...
                                <TouchableOpacity style={{alignSelf: 'center'}}>
                                    <Text style={{fontSize:12, textDecorationLine: 'underline', color: '#C6C6C6'}}>포기하기</Text>
                                </TouchableOpacity>
                            </View>
                            <View style={{
                                flexDirection: 'row',
                                ...
                                <Text style={{ fontSize: 16, fontWeight: 'bold', marginLeft: 8 }} >성공률</Text>
                            </View>
                            ...
                            <View style={{
                                ...
                                <Text style={{ fontSize: 16, fontWeight: 'bold', marginLeft: 8 }}>상금정보</Text>
                            </View>
